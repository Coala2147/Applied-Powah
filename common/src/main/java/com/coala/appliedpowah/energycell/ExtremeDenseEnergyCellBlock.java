...
/** Extreme-dense AE cell — 8 × super-dense = 102.4M AE. */
public class ExtremeDenseEnergyCellBlock extends APDenseEnergyCellBlock {
    public static final double MAX_POWER = 102_400_000D;
    public static final double CHARGE_RATE = 102_400D;
    public static final int PRIORITY = 12800;
